...
/**
* Vue directive to wrap the minimal autosize.js system to handle textarea sizing to content
*
* @example Simple auto-sizing textarea component
* <textarea v-autosize v-model="textContent"/>
*/
export default {
	mounted(el) {
		autosize(el);
